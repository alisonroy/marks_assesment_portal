...
<head>
    ...
    <title>Department Reports | xStack</title>
...
<body>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                                ...
                                <div class="d-flex justify-content-between flex-wrap">
                                    <div class="d-flex align-items-center dashboard-header flex-wrap mb-3 mb-sm-0">
                                        ...
                                        <div class="d-flex align-items-baseline dashboard-breadcrumb">
                                            ...
                                            <i class="mdi mdi-chevron-right mr-1 text-muted"></i>
                                            <p class="text-muted mb-0 hover-cursor">Department Reports</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="reportview" class="forms-sample mt-3">
                                        <div class="row">
                                            <div class="col-12 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control d-none" id="deptmech">
                                        ...
                                        <div class="form-group mt-4 d-flex justify-content-end">
                                            <div id="departmentreportsloader">
                        ...
                        <iframe frameborder="0" class="excel-view-iframe mt-5 d-none" id="hod-Iframe" scrolling="no" style="display: block;"></iframe>
                        <div class="container d-none justify-content-end mt-3 mr-3" id="hod-utilities">
                            <a href="#" class="btn btn-primary font-weight-bold" onclick="(function(){window.location.reload()})()">
                                Reset
                            </a>
                            <a class="btn btn-primary font-weight-bold ml-2" id="hod-report-download">
                                Download
                            </a>
                        </div>
    ...
    <script src="js/hod-classview.js"></script>
</body>

...
document.getElementById("collegereportsloader").style.display = "none";
      ...
      if (
        ...
        $(function () {
          $("#year").on("change", function (e) {
            document.getElementById("collegereportsloader").style.display =
              "block";
            ...
            $.ajax({
              ...
              success: function (responsePath) {
                ...
                if (parsedPath != "false") {
                  ...
                  document
                    .getElementById("mgmt-Iframe")
                    .classList.remove("d-none");
                  document
                    .getElementById("mgmt-utilities")
                    .classList.remove("d-none");
                  document
                    .getElementById("mgmt-utilities")

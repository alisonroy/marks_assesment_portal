...
document.getElementById("reportsloader").style.display = "block";
document.getElementById("reportscontainer").style.display = "none";
document.getElementById("departmentreportsloader").style.display = "none";
    ...
    if (parsedResponse != "false") {
      if (parsedResponse["user_type"] == "hod") {
        if (parsedResponse["department"] == "dme") {
          document.getElementById("deptmech").classList.remove("d-none");
        } else {
      ...
      document.getElementById("reportsloader").style.display = "none";
      document.getElementById("reportscontainer").style.display = "block";
      $(function () {
        $("#year").on("change", function (e) {
          document.getElementById("departmentreportsloader").style.display =
            "block";
          if (parsedResponse["department"] == "dme") {
            document.getElementById("deptmech").value;
          } else {
          ...
          $.ajax({
            ...
            success: function (responseSub) {
              var parsedSub = JSON.parse(responseSub);
              if (parsedSub != "false") {
                ...
                for (var i in parsedSub) {
                  if (typeof parsedSub[i].subject_code != "undefined") {
                    ...
                    subject.classList.remove("disabledDiv");
                  }
                }
                document.getElementById(
                  "departmentreportsloader"
                ).style.display = "none";
              }
            },
            error: function (e) {},
          ...
          $.ajax({
            ...
            success: function (responsePath) {
              ...
              if (parsedPath != "false") {
                ...
                document
                  .getElementById("hod-Iframe")
                  .classList.remove("d-none");
                document
                  .getElementById("hod-utilities")
                  .classList.remove("d-none");
                document
                  .getElementById("hod-utilities")

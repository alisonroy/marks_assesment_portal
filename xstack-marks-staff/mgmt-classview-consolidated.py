...
workbook_name = os.path.join(os.path.join(dirname, "mm-xport-generated"),
                             'GeneratedMGMTConMMReport_' + random_string(8) + '.xlsx').replace('\\\\', '/')
...
def prepare_workbook(worksheet, subject_code, department, semester, subject_det, exam, stu_details):
    ...
    worksheet.merge_range('A1:BZ1', 'Marks Module : College Reports - Consolidated - Loyola-ICAM College of Engineering and Technology',
                          file_head_format)

...
workbook_name = os.path.join(os.path.join(dirname, "mm-xport-generated"),
                             'GeneratedMGMTCumMMReport_' + random_string(8) + '.xlsx').replace('\\\\', '/')
...
def prepare_workbook(worksheet, subject_code, department, semester, sub_det, col_name, exams):
    ...
    worksheet.merge_range('A1:BZ1', 'Marks Module : College Reports - Cummulative - Loyola-ICAM College of Engineering and Technology',
                          file_head_format)
